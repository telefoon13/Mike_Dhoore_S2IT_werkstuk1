...
class Personen:NSObject {
    ...
    override init(){
        ...
        let persoon11 = Persoon(naam: "Vijver", vNaam: "Pakahandtas", foto: "vrouw", adres: adres2, coordinaten: coordinaten11, telefoon: "0411/04.04.99")
        let persoon12 = Persoon(naam: "Laka", vNaam: "Beest", foto: "man", adres: adres3, coordinaten: coordinaten12, telefoon: "0403/12.04.99")
        let persoon13 = Persoon(naam: "Tjaka", vNaam: "Belle", foto: "vrouw", adres: adres0, coordinaten: coordinaten13, telefoon: "0403/13.04.99")
        let persoon14 = Persoon(naam: "Naam", vNaam: "voornaam", foto: "vrouw", adres: adres4, coordinaten: coordinaten14, telefoon: "0403/14.04.99")
